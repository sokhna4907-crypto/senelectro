            ...
            <div>
              {infos.map((info, i) => (
                <div key={i} className="py-6" style={{ borderBottom: '0.5px solid rgba(255,255,255,0.05)' }}>
                  <div className="text-xs uppercase tracking-widest mb-2" style={{ color: 'rgba(255,255,255,0.25)', letterSpacing: '2px' }}>{info.label}</div>
            ...
            <div className="p-8" style={{ background: '#0D1A2D', border: '0.5px solid rgba(255,255,255,0.06)' }}>
              {submitted ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                  ...
                  <div className="text-sm font-light" style={{ color: 'rgba(255,255,255,0.4)' }}>Nous vous répondons dans les plus brefs délais.</div>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex flex-col gap-5">
                    {[
                      ...
                      <div key={field.key}>
                        <label className="block text-xs uppercase tracking-widest mb-2" style={{ color: 'rgba(255,255,255,0.25)', letterSpacing: '2px' }}>{field.label}</label>
                    ...
                    <div>
                      <label className="block text-xs uppercase tracking-widest mb-2" style={{ color: 'rgba(255,255,255,0.25)', letterSpacing: '2px' }}>Message *</label>
                    ...
                    {error && <div className="text-xs py-2 px-4" style={{ background: 'rgba(226,75,74,0.1)', border: '0.5px solid rgba(226,75,74,0.3)', color: '#E24B4A' }}>{error}</div>}
