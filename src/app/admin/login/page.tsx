    ...
    <main className="min-h-screen flex items-center justify-center" style={{ background: '#08111F' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-12">
          ...
          <div className="text-xs uppercase tracking-widest" style={{ color: 'rgba(255,255,255,0.2)', letterSpacing: '3px' }}>
            Administration
          </div>
        </div>
          ...
          <div className="flex flex-col gap-5">
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                placeholder="admin@senelectro.com"
            ...
            {error && (
              <div className="text-xs text-center py-2 px-4"
